...
# # "ethics-hard-short" "ethics-short" "jiminy" "jiminy-neutral" "jiminy-subset" "socialchemistry" "moralchoice-open-low-ambiguity" "moralchoice-two-choice-low-ambiguity"
# # "moralchoice-open-high-ambiguity"
...
#   # python edit_circumstance_specific.py --hparams_dir=GRACE/llama2-7b --device=4 --eval_data_name=$data_name &
#   # python edit_circumstance_specific.py --hparams_dir=GRACE/llama3-8b --device=5 --eval_data_name=$data_name &
#   # python edit_circumstance_specific.py --hparams_dir=GRACE/mistral-7b --device=6 --eval_data_name=$data_name &
#   # python edit_circumstance_specific.py --hparams_dir=GRACE/deepseek-qwen-7b --device=7 --eval_data_name=$data_name
#   # wait
...
# python edit_circumstance_specific_api.py --model_name=claude-3-sonnet-20240229  # anthropic.NotFoundError: Error code: 404
# python edit_circumstance_specific_api.py --model_name=claude-3-opus-20240229 --eval_size=3  # $75 / MTok
(
...
(
  ...
  python edit_circumstance_specific_api.py --model_name=gemini-2.5-pro-preview-05-06
...
(
  python edit_circumstance_specific_api.py --model_name=deepseek-chat
  python edit_circumstance_specific_api.py --model_name=deepseek-reasoner
) &

(
  python edit_circumstance_specific_api.py --model_name=llama-4-maverick-17b-128e-instruct-fp8
  # python edit_circumstance_specific_api.py --model_name=llama-4-scout-17b-16e-instruct
  python edit_circumstance_specific_api.py --model_name=llama3.1-405b-instruct-fp8
  # python edit_circumstance_specific_api.py --model_name=llama3.1-70b-instruct-fp8
) &
