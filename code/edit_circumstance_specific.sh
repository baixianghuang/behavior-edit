...
python edit_circumstance_specific.py --hparams_dir=ROME/llama2-7b --device=4 &
python edit_circumstance_specific.py --hparams_dir=ROME/llama3-8b --device=5 &
python edit_circumstance_specific.py --hparams_dir=ROME/mistral-7b --device=6 &
python edit_circumstance_specific.py --hparams_dir=ROME/deepseek-qwen-7b --device=7
wait
...
python edit_circumstance_specific.py --hparams_dir=FT-M/llama2-7b --device=4 &
python edit_circumstance_specific.py --hparams_dir=FT-M/llama3-8b --device=5 &
python edit_circumstance_specific.py --hparams_dir=FT-M/mistral-7b --device=6 &
python edit_circumstance_specific.py --hparams_dir=FT-M/deepseek-qwen-7b --device=7
wait
...
python edit_circumstance_specific.py --hparams_dir=ICE/llama2-7b --device=4 &
python edit_circumstance_specific.py --hparams_dir=ICE/llama3-8b --device=5 &
python edit_circumstance_specific.py --hparams_dir=ICE/mistral-7b --device=6 &
python edit_circumstance_specific.py --hparams_dir=ICE/deepseek-qwen-7b --device=7
wait
...
# python edit_circumstance_specific_api.py --model_name=claude-3-opus-20240229  # $75 / MTok
