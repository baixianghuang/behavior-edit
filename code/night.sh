...
# datasets=("moralchoice-two-choice-low-ambiguity")
# for data_name in "${datasets[@]}"; do
#   echo "Processing dataset: $data_name"
  
#   python edit_circumstance_specific.py --hparams_dir=ROME/llama2-7b --device=0 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=ROME/llama3-8b --device=1 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=ROME/mistral-7b --device=2 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=ROME/deepseek-qwen-7b --device=3 --eval_data_name=$data_name &
...
#   python edit_circumstance_specific.py --hparams_dir=FT-M/llama2-7b --device=0 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=FT-M/llama3-8b --device=1 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=FT-M/mistral-7b --device=2 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=FT-M/deepseek-qwen-7b --device=3 --eval_data_name=$data_name &
...
#   python edit_circumstance_specific.py --hparams_dir=ICE/llama2-7b --device=0 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=ICE/llama3-8b --device=1 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=ICE/mistral-7b --device=2 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=ICE/deepseek-qwen-7b --device=3 --eval_data_name=$data_name &
...
#   python edit_circumstance_specific.py --hparams_dir=LoRA/llama2-7b --device=0 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=LoRA/llama3-8b --device=1 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=LoRA/mistral-7b --device=2 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=LoRA/deepseek-qwen-7b --device=3 --eval_data_name=$data_name &
...
#   python edit_circumstance_specific.py --hparams_dir=GRACE/llama2-7b --device=0 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=GRACE/llama3-8b --device=1 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=GRACE/mistral-7b --device=2 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=GRACE/deepseek-qwen-7b --device=3 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=GRACE/qwen3-8b --device=4 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=GRACE/gpt-j-6b --device=5 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=GRACE/olmo2-7b --device=7 --eval_data_name=$data_name
#   wait

#   python edit_circumstance_specific.py --hparams_dir=FT-L/llama2-7b --device=0 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=FT-L/llama3-8b --device=1 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=FT-L/mistral-7b --device=2 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=FT-L/deepseek-qwen-7b --device=3 --eval_data_name=$data_name &
...
#   python edit_circumstance_specific.py --hparams_dir=MEMIT/llama2-7b --device=0 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=MEMIT/llama3-8b --device=1 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=MEMIT/mistral-7b --device=2 --eval_data_name=$data_name &
#   python edit_circumstance_specific.py --hparams_dir=MEMIT/deepseek-qwen-7b --device=3 --eval_data_name=$data_name &
...
#   python edit_impact.py --hparams_dir=MEMIT/olmo2-7b --device_pre=5 --device_post=5 --device_eval=7 --eval_data_name=$eval_data_name --output_folder_name=$output_folder_name &
#   python edit_impact.py --hparams_dir=MEMIT/gpt-j-6b --device_pre=6 --device_post=6 --device_eval=7 --eval_data_name=$eval_data_name --output_folder_name=$output_folder_name 
#   wait
...
#   python edit_impact.py --hparams_dir=LoRA/olmo2-7b --device_pre=5 --device_post=5 --device_eval=7 --eval_data_name=$eval_data_name --output_folder_name=$output_folder_name &
#   python edit_impact.py --hparams_dir=LoRA/gpt-j-6b --device_pre=6 --device_post=6 --device_eval=7 --eval_data_name=$eval_data_name --output_folder_name=$output_folder_name 
#   wait

#   python edit_impact.py --hparams_dir=FT-L/llama2-7b --device_pre=4 --device_post=4 --device_eval=7 --eval_data_name=$eval_data_name --output_folder_name=$output_folder_name &
#   python edit_impact.py --hparams_dir=FT-L/llama3-8b --device_pre=5 --device_post=5 --device_eval=7 --eval_data_name=$eval_data_name --output_folder_name=$output_folder_name &
#   python edit_impact.py --hparams_dir=FT-L/mistral-7b --device_pre=6 --device_post=6 --device_eval=7 --eval_data_name=$eval_data_name --output_folder_name=$output_folder_name
#   wait  
#   python edit_impact.py --hparams_dir=FT-L/deepseek-qwen-7b --device_pre=4 --device_post=4 --device_eval=7 --eval_data_name=$eval_data_name --output_folder_name=$output_folder_name &
#   python edit_impact.py --hparams_dir=FT-L/olmo2-7b --device_pre=5 --device_post=5 --device_eval=7 --eval_data_name=$eval_data_name --output_folder_name=$output_folder_name &
#   python edit_impact.py --hparams_dir=FT-L/gpt-j-6b --device_pre=6 --device_post=6 --device_eval=7 --eval_data_name=$eval_data_name --output_folder_name=$output_folder_name 
#   wait
