...
class BaseEditor:
    ...
    def __init__(self, hparams: HyperParams):
        ...
        if type(self.model_name) is str:
            ...
            if 't5' in self.model_name.lower():
            ...
            elif 'llama' in self.model_name.lower() or 'vicuna' in self.model_name.lower() or 'olmo' in self.model_name.lower():
                self.model = AutoModelForCausalLM.from_pretrained(self.model_name, torch_dtype=torch_dtype, device_map=device_map)
                ...
                self.tok = AutoTokenizer.from_pretrained(self.model_name,trust_remote_code=True)
                self.tok.pad_token_id = self.tok.eos_token_id
            elif 'qwen2' in self.model_name.lower() or 'DeepSeek-R1-Distill-Qwen' in self.model_name or 'qwen3' in self.model_name.lower():
