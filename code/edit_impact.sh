start_time=$(date +%s)
python edit_impact.py --hparams_dir=ROME/qwen3-8b --device_pre=0 --device_post=0 --device_eval=3 &
python edit_impact.py --hparams_dir=ROME/olmo2-7b --device_pre=1 --device_post=1 --device_eval=3 &
python edit_impact.py --hparams_dir=ROME/gpt-j-6b --device_pre=2 --device_post=2 --device_eval=3 
wait

python edit_impact.py --hparams_dir=FT-M/qwen3-8b --device_pre=0 --device_post=0 --device_eval=3 &
python edit_impact.py --hparams_dir=FT-M/olmo2-7b --device_pre=1 --device_post=1 --device_eval=3 &
python edit_impact.py --hparams_dir=FT-M/gpt-j-6b --device_pre=2 --device_post=2 --device_eval=3 
wait

python edit_impact.py --hparams_dir=ICE/qwen3-8b --device_pre=0 --device_post=0 --device_eval=3 &
python edit_impact.py --hparams_dir=ICE/olmo2-7b --device_pre=1 --device_post=1 --device_eval=3 &
python edit_impact.py --hparams_dir=ICE/gpt-j-6b --device_pre=2 --device_post=2 --device_eval=3 
wait

# python edit_impact.py --hparams_dir=FT-L/llama3-8b --device_pre=1 --device_post=1 --device_eval=3 --eval_size=10
